...
import { ProfilePersonalInfoInputComponent } from '../create-profile/profile-personal-info-input/profile-personal-info-input.component';
import { ProfileCareerInfoInputComponent } from '../create-profile/profile-career-info-input/profile-career-info-input.component';
import { ProfileReligionInfoInputComponent } from '../create-profile/profile-religion-info-input/profile-religion-info-input.component';
import { ProfileFamilyInfoInputComponent } from '../create-profile/profile-family-info-input/profile-family-info-input.component'; import { ProfileAppearanceInfoInputComponent } from '../create-profile/profile-appearance-info-input/profile-appearance-info-input.component';
import { ProfileLifestyleInfoInputComponent } from '../create-profile/profile-lifestyle-info-input/profile-lifestyle-info-input.component';
...
export class CreateProfileComponent implements OnInit {
  ...
  @ViewChild(ProfilePersonalInfoInputComponent)
  personalInfoChild!: ProfilePersonalInfoInputComponent;

  @ViewChild(ProfileCareerInfoInputComponent)
  careerInfoChild!: ProfileCareerInfoInputComponent;

  @ViewChild(ProfileReligionInfoInputComponent)
  religionInfoChild!: ProfileReligionInfoInputComponent;

  @ViewChild(ProfileFamilyInfoInputComponent)
  familyInfoChild!: ProfileFamilyInfoInputComponent;

 

  @ViewChild(ProfileAppearanceInfoInputComponent)
  appearanceInfoChild!: ProfileAppearanceInfoInputComponent;

  

  @ViewChild(ProfileLifestyleInfoInputComponent)
  lifestyleInfoChild!: ProfileLifestyleInfoInputComponent;
  ...
  save(): void {
    switch (this.stepper) {
      case 1: this.personalInfoChild.save(); break;  
      case 2: this.careerInfoChild.save();   break;  
      case 3: this.religionInfoChild.save(); break;
      case 4: this.familyInfoChild.save();   break;
      case 5: this.appearanceInfoChild.save(); break;
      case 6: this.lifestyleInfoChild.save();  break;
    }
  }
