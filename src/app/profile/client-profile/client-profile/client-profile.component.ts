...
export class ClientProfileComponent implements OnInit {
  ...
  loadProfile(): void {
    ...
    (
      this.sharedDataService.getHttp(
      ...
      },
      {
        ...
        items: [
          { description: 'Gender', value: gender?.subTypeTitle || '-' },
          {
            ...
            value: user.phoneNo || user.phoneNumber || '-',
          },
      ...
      },
      {
        ...
        items: [
          ...
          { description: 'Sect', value: sect?.subTypeTitle || '-' },
          {
            ...
            value: religionImp?.subTypeTitle || '-',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            value: fatherOcc?.subTypeTitle || '-',
          },
          {
            description: "Mother's Occupation",
            value: motherOcc?.subTypeTitle || '-',
          },
          {
            description: 'Housing Situation',
            value: housing?.subTypeTitle || '-',
          },
          {
            description: 'No. of Siblings',
            value: siblings?.subTypeTitle || '-',
          },
          {
            description: 'Family Involvement',
            value: family?.subTypeTitle || '-',
          },
          {
            description: 'Marital Status',
            value: marital?.subTypeTitle || '-',
          },
        ],
      },
    ];
