...
appearancePrefChild!: PreferencesAppearanceComponent;
  ...
  save(): void {
    switch (this.stepper) {
      case 1: this.personalPrefChild.save(); break;
      case 2: /* careerPrefChild.save()     */ break;
      case 3: this.religionPrefChild.save(); break;
      case 4: /* familyPrefChild.save()     */ break;
      case 5: this.appearancePrefChild.save(); break;
      case 6: this.lifestylePrefChild.save(); break;
    }
  }

  // ─── Child saveSuccess handlers ───────────────────────────────────────────
  onPersonalPrefSaveSuccess(): void   { this.stepper = 2; }
  onCareerPrefSaveSuccess(): void     { this.stepper = 3; }
  onReligionPrefSaveSuccess(): void   { this.stepper = 4; }
  onFamilyPrefSaveSuccess(): void     { this.stepper = 5; }
  onAppearancePrefSaveSuccess(): void { this.stepper = 6; }
  onLifestylePrefSaveSuccess(): void  { console.log('All preferences saved.'); }
  ...
  assignSubType(typeID: number, data: any[]): void {
    switch (typeID) {
      ...
      case 31: this.minAgeList             = data; break; 
      case 32: this.maxAgeList             = data; break;  
