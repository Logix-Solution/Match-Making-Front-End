...
interface CareerPreferenceInterface {
  userID: number;
  spType: string;
  careerPrefrence: string;
}

@Component({
  selector: 'app-admin-prefernces-career',
  templateUrl: './admin-prefernces-career.component.html',
  styleUrls: ['./admin-prefernces-career.component.scss'],
})
export class AdminPreferncesCareerComponent implements OnInit {
  // ─── Inputs from Parent ───────────────────────────────────────────────────
