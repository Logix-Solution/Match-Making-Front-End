...
import { AdminPreferncesInfoComponent } from '../admin-prefernces-configuration/admin-prefernces-info/admin-prefernces-info.component';
import { AdminPreferncesReligionComponent } from '../admin-prefernces-configuration/admin-prefernces-religion/admin-prefernces-religion.component';
import { AdminPreferncesLifeSyleComponent } from '../admin-prefernces-configuration/admin-prefernces-life-syle/admin-prefernces-life-syle.component';
import { AdminPreferncesAppeareanceComponent } from '../admin-prefernces-configuration/admin-prefernces-appeareance/admin-prefernces-appeareance.component';
import { AdminPreferncesFamilyComponent } from '../admin-prefernces-configuration/admin-prefernces-family/admin-prefernces-family.component';
import { AdminPreferncesCareerComponent } from '../admin-prefernces-configuration/admin-prefernces-career/admin-prefernces-career.component';

@Component({
  selector: 'app-admin-prefernces-configuration',
  templateUrl: './admin-prefernces-configuration.component.html',
  styleUrls: ['./admin-prefernces-configuration.component.scss'],
})
export class AdminPreferncesConfigurationComponent implements OnInit {
  // ─── References to children ───────────────────────────────────────────────
  @ViewChild(AdminPreferncesInfoComponent)
  personalPrefChild!: AdminPreferncesInfoComponent;
  @ViewChild(AdminPreferncesReligionComponent)
  religionPrefChild!: AdminPreferncesReligionComponent;
  @ViewChild(AdminPreferncesLifeSyleComponent)
  lifestylePrefChild!: AdminPreferncesLifeSyleComponent;
  @ViewChild(AdminPreferncesAppeareanceComponent)
  appearancePrefChild!: AdminPreferncesAppeareanceComponent;

  @ViewChild(AdminPreferncesFamilyComponent)
  familyPrefChild!: AdminPreferncesFamilyComponent;
  @ViewChild(AdminPreferncesCareerComponent)
  careerPrefChild!: AdminPreferncesCareerComponent;
